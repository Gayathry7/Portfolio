    ...
    return(
        <div className={styles.navbar_back}>
          ...
          <div className={styles.navbar_flex1}>
             <div > <NavLink to="/" className={styles.text_link}>About</NavLink>  </div>
             <div> <NavLink to="/skills" className={styles.text_link}>Skills</NavLink>  </div>
             <div> <NavLink to="/projects" className={styles.text_link}>Projects</NavLink> </div> 
